...
import {
  ...
  RouteData,
  SignedOrder,
  SignedPermitSignatureData,
} from "../../trading/executor/executor-types";
...
export class Executor {
  ...
  async getPermit2(wallet: Wallet): Promise<string> {
    const executorContract = new Contract(this.executorAddress, EXECUTOR_INTERFACE, wallet);
    return await executorContract.PERMIT2();
  }
  ...
  static encodeExecuteOrder(
    signedPermitData: SignedPermitSignatureData,
