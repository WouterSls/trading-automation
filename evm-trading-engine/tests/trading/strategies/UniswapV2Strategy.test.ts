...
describe("Uniswap V2 Strategy Test", () => {
  ...
  beforeAll(async () => {
    ...
    strategy = new UniswapV2Strategy(chain);
  });
  ...
  describe("constructor and basic setup", () => {
    ...
    it("should initialize with correct chain configuration", () => {
      const testStrategy = new UniswapV2Strategy(ChainType.ETH);
...
describe("Cross-Chain consistency", () => {
  ...
  describe("cross-chain consistency", () => {
    it("should maintain similar interface across chains", async () => {
      const arbStrategy = new UniswapV2Strategy(ChainType.ARB);
      expect(arbStrategy.getName()).toBe("UniswapV2");
