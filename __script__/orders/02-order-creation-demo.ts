...
async function demonstrateOrderCreation() {
  ...
  try {
    ...
    console.log("│   inputAmount: " + ethers.formatUnits(orderParams.inputAmount, 6).padEnd(8) + " USDC              │");
    console.log("│   minAmountOut: " + ethers.formatEther(orderParams.minAmountOut).padEnd(6) + " ETH                │");
    console.log("│   maxSlippageBps: 100 (1%)                             │");
    console.log("│   expiry: " + new Date(signedOrder.order.expiry * 1000).toLocaleString().substring(0, 16) + "...        │");
    console.log("└─────────────────────────────────────────────────────────┘");
    console.log();
