...
describe("Uniswap V3 Strategy Test", () => {
  ...
  describe("createTransaction", () => {
    ...
    it("should include correct function signature for swapExactETHForTokens", async () => {
      ...
      const expectedSignature = UNISWAP_V3_ROUTER_INTERFACE.getFunction("swapExactETHForTokens")!.selector;
    ...
    it("should include correct function signature for swapExactTokensForTokens", async () => {
      ...
      const expectedSignature = UNISWAP_V3_ROUTER_INTERFACE.getFunction("swapExactTokensForTokens")!.selector;
    ...
    it("should include correct function signature for swapExactTokensForETH", async () => {
      ...
      const expectedSignature = UNISWAP_V3_ROUTER_INTERFACE.getFunction("swapExactTokensForETH")!.selector;
