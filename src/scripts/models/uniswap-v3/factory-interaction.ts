import { UniswapV3Factory, UniswapV3Pool, Slot0 } from "../../../models/uniswap-v3";
...
export async function factoryInteraction() {
    ...
    const pool: UniswapV3Pool  = await factory.getPool(wallet, DAI_ADDRESS, WETH_ADDRESS, FeeTier["0.3%"]);
